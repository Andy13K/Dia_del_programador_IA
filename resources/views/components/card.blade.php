...
<div {{ $attributes->merge(['class' => 'kin-panel bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden']) }}>
    @if($header)
