        ...
        <x-table>
            ...
            <tfoot class="bg-slate-100 dark:bg-slate-800 font-bold text-slate-900 dark:text-white border-t-2 border-slate-300 dark:border-slate-700 text-xs">
                <tr>
                    ...
                    <td class="px-6 py-4 text-right font-mono text-amber-600 dark:text-amber-400">{{ number_format($totalKw, 2) }} kW</td>
                    <td class="px-6 py-4 text-right font-mono">{{ number_format($totalKwh) }} kWh</td>
                    <td class="px-6 py-4 text-right font-mono">{{ number_format($totalFam) }}</td>
                    <td class="px-6 py-4 text-right font-mono text-emerald-600 dark:text-emerald-400">{{ number_format($totalKwh * 0.40 / 1000, 2) }} Ton</td>
                    <td class="px-6 py-4 text-right font-mono">{{ number_format($totalKwh * 0.40, 2) }} kg</td>
                </tr>
            </tfoot>
        </x-table>
    </div>
