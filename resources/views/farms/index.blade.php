...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
        <form data-reactive-filter method="GET" action="{{ route('farms.index') }}" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            <div>
                <label for="farmSearch" class="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1">Buscar por Nombre</label>
                <input id="farmSearch" type="text" name="search" value="{{ $filters['search'] ?? '' }}" placeholder="Ej. Escuintla, Guayacán..."
            ...
            <div>
                <label for="farmDepartment" class="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1">Departamento</label>
                <select id="farmDepartment" name="department_id" class="w-full px-3 py-2 text-xs rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500">
            ...
            <div>
                <label for="farmStatus" class="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1">Estado Operativo</label>
                <select id="farmStatus" name="status" class="w-full px-3 py-2 text-xs rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500">
